...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{residual_vs_x.png}
    \vspace{-12pt}
    \caption{L2 residual at each $x$-location.}
...
\begin{figure}[H]
    ...
    \vspace{-12pt}
    \caption{L2 error between numerical and analytical solutions at each $x$-location.}
