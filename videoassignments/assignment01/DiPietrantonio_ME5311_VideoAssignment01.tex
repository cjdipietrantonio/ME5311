...
\noindent As mentioned in ``An Introduction to Computational Fluid Dynamics: The Finite Volume Method'' by H.K. Versteeg and W. Malalasekera, deriving the governing equation for the kinetic energy allows us to separate the kinetic/mechanical (effects of pressure forces, viscous stresses, and subsequent source terms) contributions to the total energy of the fluid from the contributions of internal energy, heat transfer, viscous dissipation, or other thermal sources. Doing so also allows us to obtain expressions for quantities such as internal energy, $i$ or temperature, $T$.
